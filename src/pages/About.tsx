    ...
    <div className="bg-white">
      <div className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:py-24 lg:px-8">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl font-extrabold text-[var(--gray-900)]">À Propos de Temba</h2>
        ...
        <div className="mt-12 lg:mt-20">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              <div className="flex items-center justify-center h-12 w-12 rounded-md bg-[var(--primary-500)] text-white mx-auto">
                <Building />
              </div>
              <div className="mt-5">
                <h3 className="text-lg font-medium text-[var(--gray-900)]">Notre Entreprise</h3>
            ...
            <div className="text-center">
              ...
              <div className="mt-5">
                <h3 className="text-lg font-medium text-[var(--gray-900)]">Notre Mission</h3>
                <p className="mt-2 text-base text-gray-500">
            ...
            <div className="text-center">
              ...
              <div className="mt-5">
                <h3 className="text-lg font-medium text-[var(--gray-900)]">Notre Équipe</h3>
                <p className="mt-2 text-base text-gray-500">
