...
import { Search, MapPin, Users, CheckCircle, Calendar } from 'lucide-react';
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        ...
        <div className="bg-paper border border-line rounded-2xl shadow-card p-5 sm:p-6 mb-6">
          <div className="flex items-center gap-3 mb-5">
            ...
            <div>
              ...
              <p className="text-[12px] text-ink-mute">{organizers.length} organisateur{organizers.length !== 1 ? 's' : ''} sur Temba</p>
            </div>
          </div>
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {filtered.map(org => (
              <Link key={org.id} to={`/organizers/${org.slug}`}
