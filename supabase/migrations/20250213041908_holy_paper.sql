...
BEGIN
  IF NOT EXISTS (
    ...
    ALTER TABLE tickets ADD COLUMN transfer_id uuid REFERENCES ticket_transfers(id);
  END IF;
END $$;
...
DROP FUNCTION IF EXISTS transfer_ticket;
DROP FUNCTION IF EXISTS accept_ticket_transfer;
