...
DO $$ 
BEGIN
  -- Drop policies from ticket_transfers if they exist
  IF EXISTS (
...
-- Create improved view for ticket transfer details
...
CREATE POLICY "transfer_select_policy_v1"
...
CREATE POLICY "transfer_insert_policy_v1"
