...
CREATE POLICY "orders_insert_policy_new"
ON orders
FOR INSERT
WITH CHECK (
...
CREATE POLICY "orders_select_policy_new"
ON orders
FOR SELECT
USING (
...
CREATE POLICY "guest_orders_insert_policy_new"
ON guest_orders
FOR INSERT
WITH CHECK (true);

CREATE POLICY "guest_orders_select_policy_new"
ON guest_orders
FOR SELECT
USING (
