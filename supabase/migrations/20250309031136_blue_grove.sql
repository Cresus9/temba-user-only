/*
  ...
  1. Changes
    ...
    - Create new view with proper joins and relationships
...
FROM 
  ticket_transfers tt
  JOIN profiles sender_profile ON tt.sender_id = sender_profile.user_id
